...
<template>
  ...
  <div v-for="g in groupedMessages" :key="g.user.id" class="space-y-2">
    <div class="rounded-xl px-3 py-2 ui-surface-1 bg-hoi4-accent/30 text-hoi4-text">
    ...
    <div
      ...
      class="rounded-xl px-3 py-2 ui-surface-2 text-hoi4-text"
    >
      ...
      <div class="space-y-2">
        <div v-for="m in g.items" :key="m.id">
          <div v-if="m.reasoning && m.reasoning.trim().length > 0" class="mb-2">
            <button
              class="text-xs px-2 py-1 rounded-lg bg-hoi4-border/50 hover:bg-hoi4-border/70 transition-colors"
            ...
            <div
              ...
              class="mt-2 rounded-xl ui-surface-1 px-3 py-2"
            >
          ...
          <div class="text-sm whitespace-pre-wrap break-words" :class="m.pending ? 'animate-pulse text-hoi4-text-dim' : ''">
            <template v-if="isToolResultMessage(m)">
              <details
                class="rounded-xl ui-surface-1 px-3 py-2"
              ...
              >
                ...
                <pre
                  ...
                  class="mt-2 text-xs whitespace-pre-wrap break-words text-hoi4-text-dim ui-surface-2 rounded-lg p-2"
                >{{ m.content }}</pre>
              </details>
            </template>
